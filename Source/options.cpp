...
GameplayOptions::GameplayOptions()
    ...
    , lockOnTarget("Lock-On Target", OptionEntryFlags::None, N_("Lock-On Target"), N_("When enabled the last target is locked-on when attacking with the mouse held down."), true)
