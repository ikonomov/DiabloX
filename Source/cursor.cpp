...
void CheckCursMove()
{
	...
	if (((*sgOptions.Gameplay.lockOnTarget & sgbMouseDown != CLICK_NONE) || ControllerActionHeld != GameActionType_NONE) && IsNoneOf(LastMouseButtonAction, MouseActionType::None, MouseActionType::Attack, MouseActionType::Spell)) {
		InvalidateTargets();
